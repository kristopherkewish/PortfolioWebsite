...
const fortuneTeller = {
    ...
    tellFortune () {
        ...
        return `Today your luck score is: ${luckRating}, which means ${luckDescription.toLowerCase()} You ${achieveGoals} achieve your goals today, and ${fortune}`;
    }
};

let outputArea = document.querySelector("#fortune-area");
let button = document.getElementById("get-fortune");


let printMessage = function() {
    outputArea.innerHTML = fortuneTeller.tellFortune();
    button.removeEventListener('click', printMessage);
    button.innerHTML = 'No more fortunes today!';
}
